...
import 'package:project_1/ece/ece_4/tools/ece4_question_card.dart';
...
import 'controllers/ece4_qpc.dart';

class EceSem4 extends StatelessWidget {
  const EceSem4({super.key});
  static const String routeName = "/ecesem4";

  @override
  Widget build(BuildContext context) {
    ECE4QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
