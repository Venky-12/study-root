...
import '../../ece_3/controllers/ece3_qpc.dart';
import '../screens/ece4_result_screen.dart';
import 'ece4_qpc.dart';

class Ece4QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece4ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE4QPC>().navigateToQuestions(
