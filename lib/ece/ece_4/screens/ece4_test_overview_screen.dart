...
class Ece4TestOverviewScreen extends GetView<Ece4QuestionsController> {
  const Ece4TestOverviewScreen({super.key});

  static const String routeName = "/ece4testoverview";
