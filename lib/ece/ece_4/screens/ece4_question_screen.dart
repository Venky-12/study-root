...
import 'ece4_test_overview_screen.dart';

class Ece4QuestionsScreen extends GetView<Ece4QuestionsController> {
  const Ece4QuestionsScreen({super.key});
  static const String routeName = "/ece4questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Ece4QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Ece4TestOverviewScreen.routeName)
