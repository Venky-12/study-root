...
import '../screens/ece4_test_overview_screen.dart';

class Ece4CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece4CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece4TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
