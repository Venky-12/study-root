...
import '../screens/ece6_result_screen.dart';
import 'ece_6_qpc.dart';

class Ece6QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece6ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE6QPC>().navigateToQuestions(
