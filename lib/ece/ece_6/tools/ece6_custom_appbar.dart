...
import '../screens/ece6_test_overview_screen.dart';

class Ece6CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece6CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece6TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
