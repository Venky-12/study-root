...
class Ece6TestOverviewScreen extends GetView<Ece6QuestionsController> {
  const Ece6TestOverviewScreen({super.key});

  static const String routeName = "/ece6testoverview";
