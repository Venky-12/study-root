...
import '../screens/ece5_test_overview_screen.dart';

class Ece5CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece5CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece5TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
