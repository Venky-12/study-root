...
import '../controllers/ece5_questions_controller.dart';
import '../tools/ece5_custom_appbar.dart';

class Ece5ResultScreen extends GetView<Ece5QuestionsController> {
  const Ece5ResultScreen({super.key});
  static const String routeName = "/ece5resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Ece5AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
