...
class Ece5TestOverviewScreen extends GetView<Ece5QuestionsController> {
  const Ece5TestOverviewScreen({super.key});

  static const String routeName = "/ece5testoverview";
