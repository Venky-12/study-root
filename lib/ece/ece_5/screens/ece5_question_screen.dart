...
import 'ece5_test_overview_screen.dart';

class Ece5QuestionsScreen extends GetView<Ece5QuestionsController> {
  const Ece5QuestionsScreen({super.key});
  static const String routeName = "/ece5questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Ece5QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Ece5TestOverviewScreen.routeName)
