...
import 'controllers/ece5_qpc.dart';

class EceSem5 extends StatelessWidget {
  const EceSem5({super.key});
  static const String routeName = "/ecesem5";

  @override
  Widget build(BuildContext context) {
    ECE5QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
