...
import '../screens/ece3_result_screen.dart';
import 'ece3_qpc.dart';

class Ece3QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece3ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE3QPC>().navigateToQuestions(
