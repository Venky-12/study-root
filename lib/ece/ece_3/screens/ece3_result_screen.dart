...
import 'package:project_1/ece/ece_3/controllers/ece3_questions_controller_extension.dart';
...
import '../controllers/ece3_questions_controller.dart';
import '../tools/ece3_custom_appbar.dart';
import 'ece3_answer_check_screen.dart';

class Ece3ResultScreen extends GetView<Ece3QuestionsController> {
  const Ece3ResultScreen({super.key});
  static const String routeName = "/ece3resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Ece3AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
