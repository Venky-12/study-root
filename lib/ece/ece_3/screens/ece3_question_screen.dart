...
import 'ece3_test_overview_screen.dart';

class Ece3QuestionsScreen extends GetView<Ece3QuestionsController> {
  const Ece3QuestionsScreen({super.key});
  static const String routeName = "/ece3questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Ece3QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Ece3TestOverviewScreen.routeName)
