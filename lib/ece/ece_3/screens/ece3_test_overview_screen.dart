...
class Ece3TestOverviewScreen extends GetView<Ece3QuestionsController> {
  const Ece3TestOverviewScreen({super.key});

  static const String routeName = "/ece3testoverview";
