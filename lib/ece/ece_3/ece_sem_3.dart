...
import 'package:project_1/ece/ece_3/tools/ece3_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

import 'controllers/ece3_qpc.dart';

class EceSem3 extends StatelessWidget {
  const EceSem3({super.key});
  static const String routeName = "/ecesem3";

  @override
  Widget build(BuildContext context) {
    ECE3QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
