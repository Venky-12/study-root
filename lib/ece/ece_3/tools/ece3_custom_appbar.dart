...
import '../screens/ece3_test_overview_screen.dart';

class Ece3CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece3CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece3TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
