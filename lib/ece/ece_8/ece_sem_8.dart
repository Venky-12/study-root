...
import 'package:project_1/ece/ece_8/tools/ece8_question_card.dart';
...
class EceSem8 extends StatelessWidget {
  const EceSem8({super.key});
  static const String routeName = "/ecesem8";

  @override
  Widget build(BuildContext context) {
    ECE8QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
