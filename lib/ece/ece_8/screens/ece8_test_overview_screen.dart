...
class Ece8TestOverviewScreen extends GetView<Ece8QuestionsController> {
  const Ece8TestOverviewScreen({super.key});

  static const String routeName = "/ece8testoverview";
