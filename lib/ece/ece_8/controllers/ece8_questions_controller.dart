...
import 'package:project_1/ece/ece_8/controllers/ece8_qpc.dart';
import 'package:project_1/ece/ece_8/screens/ece8_result_screen.dart';
...
class Ece8QuestionsController extends GetxController {
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> questionQuery =
          await eceSemVIIIqpRF
              .doc(questionPaper.id)
              .collection("eceSem8Questions")
              .get();
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece8ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE8QPC>().navigateToQuestions(
