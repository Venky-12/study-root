...
import '../screens/ece7_test_overview_screen.dart';

class Ece7CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece7CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece7TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
