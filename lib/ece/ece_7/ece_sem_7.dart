...
import 'package:project_1/ece/ece_7/tools/ece7_question_card.dart';
...
import 'controllers/ece7_qpc.dart';

class EceSem7 extends StatelessWidget {
  const EceSem7({super.key});
  static const String routeName = "/ecesem7";

  @override
  Widget build(BuildContext context) {
    ECE7QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
