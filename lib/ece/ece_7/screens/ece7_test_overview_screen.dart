...
class Ece7TestOverviewScreen extends GetView<Ece7QuestionsController> {
  const Ece7TestOverviewScreen({super.key});

  static const String routeName = "/ece7testoverview";
