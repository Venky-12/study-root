...
import 'ece7_test_overview_screen.dart';

class Ece7QuestionsScreen extends GetView<Ece7QuestionsController> {
  const Ece7QuestionsScreen({super.key});
  static const String routeName = "/ece7questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Ece7QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Ece7TestOverviewScreen.routeName)
