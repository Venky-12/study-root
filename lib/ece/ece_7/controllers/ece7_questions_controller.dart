...
import 'package:project_1/ece/ece_7/controllers/ece7_qpc.dart';
...
import '../screens/ece7_result_screen.dart';

class Ece7QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece7ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE7QPC>().navigateToQuestions(
