...
import 'package:project_1/ece/ece_1/tools/ece1_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

import 'controllers/ece1_qpc.dart';

class EceSem1 extends StatelessWidget {
  const EceSem1({super.key});
  static const String routeName = "/ecesem1";

  @override
  Widget build(BuildContext context) {
    ECE1QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
