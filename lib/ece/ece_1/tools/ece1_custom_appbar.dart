...
import '../screens/ece1_test_overview_screen.dart';

class Ece1CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece1CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece1TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
