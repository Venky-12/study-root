...
import 'ece1_answer_check_screen.dart';

class Ece1ResultScreen extends GetView<Ece1QuestionsController> {
  const Ece1ResultScreen({super.key});
  static const String routeName = "/ece1resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Ece1AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
