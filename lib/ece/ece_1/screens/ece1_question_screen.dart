...
import '../tools/ece1_custom_appbar.dart';
import 'ece1_test_overview_screen.dart';

class Ece1QuestionsScreen extends GetView<Ece1QuestionsController> {
  const Ece1QuestionsScreen({super.key});
  static const String routeName = "/ece1questionsscreen";

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: Ece1CustomAppBar(
        leading: Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Ece1QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Ece1TestOverviewScreen.routeName)
