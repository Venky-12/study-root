...
import '../screens/ece1_result_screen.dart';

class Ece1QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece1ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE1QPC>().navigateToQuestions(
