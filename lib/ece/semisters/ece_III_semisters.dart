...
class SemistersECEIII extends StatefulWidget {
  const SemistersECEIII({super.key});

  @override
  State<SemistersECEIII> createState() => _SemistersECEIIIState();
}

class _SemistersECEIIIState extends State<SemistersECEIII> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/ece_sem5"),
                text: "Semister-V",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/ece_sem6"),
                text: "Semister-VI",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
