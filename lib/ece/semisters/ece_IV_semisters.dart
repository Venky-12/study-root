...
class SemistersECEIV extends StatefulWidget {
  const SemistersECEIV({super.key});

  @override
  State<SemistersECEIV> createState() => _SemistersECEIVState();
}

class _SemistersECEIVState extends State<SemistersECEIV> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/ece_sem7"),
                text: "Semister-VII",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/ece_sem8"),
                text: "Semister-VIII",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
