...
class SemistersECEI extends StatefulWidget {
  const SemistersECEI({super.key});

  @override
  State<SemistersECEI> createState() => _SemistersECEIState();
}

class _SemistersECEIState extends State<SemistersECEI> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/ece_sem1"),
                text: "Semister-I",
