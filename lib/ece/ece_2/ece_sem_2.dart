...
import 'package:project_1/ece/ece_2/tools/ece2_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

import 'controllers/ece2_qpc.dart';

class EceSem2 extends StatelessWidget {
  const EceSem2({super.key});
  static const String routeName = "/ecesem2";

  @override
  Widget build(BuildContext context) {
    ECE2QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
