...
import '../screens/ece2_test_overview_screen.dart';

class Ece2CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Ece2CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Ece2TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
