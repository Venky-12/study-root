...
import 'package:project_1/ece/ece_1/controllers/ece1_qpc.dart';
...
import '../screens/ece2_result_screen.dart';
import 'ece2_qpc.dart';

class Ece2QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Ece2ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<ECE2QPC>().navigateToQuestions(
