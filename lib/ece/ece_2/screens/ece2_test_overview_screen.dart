...
class Ece2TestOverviewScreen extends GetView<Ece2QuestionsController> {
  const Ece2TestOverviewScreen({super.key});

  static const String routeName = "/ece2testoverview";
