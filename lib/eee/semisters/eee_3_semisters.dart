...
class SemistersEEEIII extends StatefulWidget {
  const SemistersEEEIII({super.key});

  @override
  State<SemistersEEEIII> createState() => _SemistersEEEIIIState();
}

class _SemistersEEEIIIState extends State<SemistersEEEIII> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/eee_sem5"),
                text: "Semister-V",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/eee_sem6"),
                text: "Semister-VI",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
