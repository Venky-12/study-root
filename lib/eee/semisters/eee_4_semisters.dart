...
class SemistersEEEIV extends StatefulWidget {
  const SemistersEEEIV({super.key});

  @override
  State<SemistersEEEIV> createState() => _SemistersEEEIVState();
}

class _SemistersEEEIVState extends State<SemistersEEEIV> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/eee_sem7"),
                text: "Semister-VII",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/eee_sem8"),
                text: "Semister-VIII",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
