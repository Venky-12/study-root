...
class Eee5TestOverviewScreen extends GetView<Eee5QuestionsController> {
  const Eee5TestOverviewScreen({super.key});

  static const String routeName = "/eee5testoverview";
