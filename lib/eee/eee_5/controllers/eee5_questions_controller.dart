...
import '../screens/eee5_result_screen.dart';

class Eee5QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee5ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee5QPC>().navigateToQuestions(
