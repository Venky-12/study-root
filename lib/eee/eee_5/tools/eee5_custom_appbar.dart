...
import '../screens/eee5_test_overview_screen.dart';

class Eee5CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee5CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee5TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
