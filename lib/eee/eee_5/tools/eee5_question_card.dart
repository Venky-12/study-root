...
import '../controllers/eee5_qpc.dart';

class EEE5QuestionCard extends StatelessWidget {
  EEE5QuestionCard({super.key, required this.model});

  final QuestionPaperModel model;
  final Eee5QPC _questionPaperController = Eee5QPC();
