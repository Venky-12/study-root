...
import 'package:project_1/eee/eee_7/tools/eee7_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class EeeSem7 extends StatelessWidget {
  const EeeSem7({super.key});
  static const String routeName = "/eeesem7";

  @override
  Widget build(BuildContext context) {
    Eee7QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
