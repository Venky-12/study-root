...
class Eee7TestOverviewScreen extends GetView<Eee7QuestionsController> {
  const Eee7TestOverviewScreen({super.key});

  static const String routeName = "/eee7testoverview";
