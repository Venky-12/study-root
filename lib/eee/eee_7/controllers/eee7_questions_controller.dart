...
import 'package:project_1/eee/eee_7/controllers/eee7_qpc.dart';
import 'package:project_1/eee/eee_7/screens/eee7_result_screen.dart';
...
class Eee7QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee7ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee7QPC>().navigateToQuestions(
