...
import '../screens/eee7_test_overview_screen.dart';

class Eee7CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee7CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee7TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
