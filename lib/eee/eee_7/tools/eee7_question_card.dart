...
import '../controllers/eee7_qpc.dart';

class EEE7QuestionCard extends StatelessWidget {
  EEE7QuestionCard({super.key, required this.model});

  final QuestionPaperModel model;
  final Eee7QPC _questionPaperController = Eee7QPC();
