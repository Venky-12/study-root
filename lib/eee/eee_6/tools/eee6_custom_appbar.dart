...
import '../screens/eee6_test_overview_screen.dart';

class Eee6CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee6CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee6TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
