...
import '../screens/eee6_result_screen.dart';

class Eee6QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee6ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee6QPC>().navigateToQuestions(
