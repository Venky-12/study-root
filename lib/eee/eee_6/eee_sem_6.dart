...
import 'package:project_1/eee/eee_6/tools/eee6_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class EeeSem6 extends StatelessWidget {
  const EeeSem6({super.key});
  static const String routeName = "/eeesem6";

  @override
  Widget build(BuildContext context) {
    Eee6QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
