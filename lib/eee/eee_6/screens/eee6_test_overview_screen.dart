...
class Eee6TestOverviewScreen extends GetView<Eee6QuestionsController> {
  const Eee6TestOverviewScreen({super.key});

  static const String routeName = "/eee6testoverview";
