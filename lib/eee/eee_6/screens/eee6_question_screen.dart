...
import '../tools/eee6_custom_appbar.dart';

class Eee6QuestionsScreen extends GetView<Eee6QuestionsController> {
  const Eee6QuestionsScreen({super.key});
  static const String routeName = "/eee6questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Eee6QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Eee6TestOverviewScreen.routeName)
