...
class Eee1TestOverviewScreen extends GetView<Eee1QuestionsController> {
  const Eee1TestOverviewScreen({super.key});

  static const String routeName = "/eee1testoverview";
