...
import 'package:project_1/eee/eee_1/controllers/eee1_questions_controller_extension.dart';
...
import 'eee1_answer_check_screen.dart';

class Eee1ResultScreen extends GetView<Eee1QuestionsController> {
  const Eee1ResultScreen({super.key});
  static const String routeName = "/eee1resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Eee1AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
