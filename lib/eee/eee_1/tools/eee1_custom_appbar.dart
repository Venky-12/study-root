...
import '../screens/eee1_test_overview_screen.dart';

class Eee1CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee1CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee1TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
