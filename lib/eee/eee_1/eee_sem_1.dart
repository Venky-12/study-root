...
import 'controllers/eee1_qpc.dart';

class EeeSem1 extends StatelessWidget {
  const EeeSem1({super.key});
  static const String routeName = "/eeesem1";

  @override
  Widget build(BuildContext context) {
    Eee1QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
