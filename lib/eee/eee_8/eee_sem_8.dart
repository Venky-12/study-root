...
import 'package:project_1/eee/eee_8/tools/eee8_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class EeeSem8 extends StatelessWidget {
  const EeeSem8({super.key});
  static const String routeName = "/eeesem8";

  @override
  Widget build(BuildContext context) {
    Eee8QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
