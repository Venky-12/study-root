...
import '../screens/eee8_test_overview_screen.dart';

class Eee8CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee8CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee8TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
