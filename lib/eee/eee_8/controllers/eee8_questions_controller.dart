...
import 'package:project_1/eee/eee_8/controllers/eee8_qpc.dart';
import 'package:project_1/eee/eee_8/screens/eee8_result_screen.dart';
...
class Eee8QuestionsController extends GetxController {
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> questionQuery =
          await eeeSemVIIIqpRF
              .doc(questionPaper.id)
              .collection("eeeSem8Questions")
              .get();
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee8ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee8QPC>().navigateToQuestions(
