...
class Eee8TestOverviewScreen extends GetView<Eee8QuestionsController> {
  const Eee8TestOverviewScreen({super.key});

  static const String routeName = "/eee8testoverview";
