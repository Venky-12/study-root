...
import 'eee2_test_overview_screen.dart';

class Eee2QuestionsScreen extends GetView<Eee2QuestionsController> {
  const Eee2QuestionsScreen({super.key});
  static const String routeName = "/eee2questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Eee2QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Eee2TestOverviewScreen.routeName)
