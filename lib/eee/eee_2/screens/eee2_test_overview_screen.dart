...
class Eee2TestOverviewScreen extends GetView<Eee2QuestionsController> {
  const Eee2TestOverviewScreen({super.key});

  static const String routeName = "/eee2testoverview";
