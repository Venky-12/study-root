...
import '../screens/eee4_result_screen.dart';
import 'eee4_qpc.dart';

class Eee4QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee4ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee4QPC>().navigateToQuestions(
