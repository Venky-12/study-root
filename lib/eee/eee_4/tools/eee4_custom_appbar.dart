...
import '../screens/eee4_test_overview_screen.dart';

class Eee4CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Eee4CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Eee4TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
