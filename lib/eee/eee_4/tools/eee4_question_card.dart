...
import '../controllers/eee4_qpc.dart';

class EEE4QuestionCard extends StatelessWidget {
  EEE4QuestionCard({super.key, required this.model});

  final QuestionPaperModel model;
  final Eee4QPC _questionPaperController = Eee4QPC();
