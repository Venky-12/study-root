...
import 'package:project_1/eee/eee_4/tools/eee4_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class EeeSem4 extends StatelessWidget {
  const EeeSem4({super.key});
  static const String routeName = "/eeesem4";

  @override
  Widget build(BuildContext context) {
    Eee4QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
