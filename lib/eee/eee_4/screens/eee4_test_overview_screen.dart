...
class Eee4TestOverviewScreen extends GetView<Eee4QuestionsController> {
  const Eee4TestOverviewScreen({super.key});

  static const String routeName = "/eee4testoverview";
