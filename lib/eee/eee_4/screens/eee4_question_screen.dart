...
import '../tools/eee4_custom_appbar.dart';
import 'eee4_test_overview_screen.dart';

class Eee4QuestionsScreen extends GetView<Eee4QuestionsController> {
  const Eee4QuestionsScreen({super.key});
  static const String routeName = "/eee4questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Eee4QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Eee4TestOverviewScreen.routeName)
