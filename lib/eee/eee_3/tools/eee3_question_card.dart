...
import '../controllers/eee3_qpc.dart';

class EEE3QuestionCard extends StatelessWidget {
  EEE3QuestionCard({super.key, required this.model});

  final QuestionPaperModel model;
  final Eee3QPC _questionPaperController = Eee3QPC();
