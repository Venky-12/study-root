...
import '../screens/eee3_result_screen.dart';
import 'eee3_qpc.dart';

class Eee3QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Eee3ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<Eee3QPC>().navigateToQuestions(
