...
import 'package:project_1/eee/eee_3/tools/eee3_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class EeeSem3 extends StatelessWidget {
  const EeeSem3({super.key});
  static const String routeName = "/eeesem3";

  @override
  Widget build(BuildContext context) {
    Eee3QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
