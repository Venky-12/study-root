...
import '../controllers/eee3_questions_controller.dart';
import '../tools/eee3_custom_appbar.dart';
import 'eee3_test_overview_screen.dart';

class Eee3QuestionsScreen extends GetView<Eee3QuestionsController> {
  const Eee3QuestionsScreen({super.key});
  static const String routeName = "/eee3questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Eee3QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Eee3TestOverviewScreen.routeName)
