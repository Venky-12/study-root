...
class Eee3TestOverviewScreen extends GetView<Eee3QuestionsController> {
  const Eee3TestOverviewScreen({super.key});

  static const String routeName = "/eee3testoverview";
