...
import '../screens/it1_test_overview_screen.dart';

class It1CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const It1CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(It1TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
