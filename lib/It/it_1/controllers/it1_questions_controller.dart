...
import 'package:project_1/eee/eee_1/screens/eee1_result_screen.dart';
...
import '../screens/it1_result_screen.dart';
import 'it1_qpc.dart';

class It1QuestionsController extends GetxController {
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> questionQuery = await itSemIqpRF
          .doc(questionPaper.id)
          .collection("itSem1Questions")
          .get();
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It1ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It1QPC>().navigateToQuestions(
