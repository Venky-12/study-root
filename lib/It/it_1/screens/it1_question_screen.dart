...
import 'package:project_1/It/it_1/screens/it1_test_overview_screen.dart';
...
class It1QuestionsScreen extends GetView<It1QuestionsController> {
  const It1QuestionsScreen({super.key});
  static const String routeName = "/it1questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<It1QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It1TestOverviewScreen.routeName)
