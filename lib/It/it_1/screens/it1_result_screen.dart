...
import 'package:project_1/It/it_1/controllers/it1_questions_controller_extension.dart';
import 'package:project_1/It/it_1/screens/it1_answer_check_screen.dart';
...
import '../controllers/it1_questions_controller.dart';
import '../tools/it1_custom_appbar.dart';

class It1ResultScreen extends GetView<It1QuestionsController> {
  const It1ResultScreen({super.key});
  static const String routeName = "/it1resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(It1AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
