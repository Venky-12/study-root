...
import 'controllers/it1_qpc.dart';

class ItSem1 extends StatelessWidget {
  const ItSem1({super.key});
  static const String routeName = "/itsem1";

  @override
  Widget build(BuildContext context) {
    It1QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
