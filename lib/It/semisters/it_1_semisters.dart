...
class SemistersItI extends StatefulWidget {
  const SemistersItI({super.key});

  @override
  State<SemistersItI> createState() => _SemistersItIState();
}

class _SemistersItIState extends State<SemistersItI> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/it_sem1"),
                text: "Semister-I",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/it_sem2"),
                text: "Semister-II",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
