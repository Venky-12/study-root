...
import 'package:project_1/It/it_6/tools/it6_question_card.dart';
import 'package:project_1/It/it_7/tools/it7_question_card.dart';
...
import 'controllers/it7_qpc.dart';

class ItSem7 extends StatelessWidget {
  const ItSem7({super.key});
  static const String routeName = "/itsem7";

  @override
  Widget build(BuildContext context) {
    It7QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
