...
import 'package:project_1/It/it_7/controllers/it7_qpc.dart';
...
import '../screens/it7_result_screen.dart';

class It7QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It7ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It7QPC>().navigateToQuestions(
