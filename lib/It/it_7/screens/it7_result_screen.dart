...
import 'package:project_1/It/it_7/controllers/it7_questions_controller_extension.dart';
import 'package:project_1/It/it_7/screens/it7_answer_check_screen.dart';
...
import '../tools/it7_custom_appbar.dart';

class It7ResultScreen extends GetView<It7QuestionsController> {
  const It7ResultScreen({super.key});
  static const String routeName = "/it7resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(It7AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
