...
import '../screens/it4_test_overview_screen.dart';

class It4CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const It4CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(It4TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
