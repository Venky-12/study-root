...
import 'package:project_1/It/it_4/tools/it4_question_card.dart';
...
import 'controllers/it4_qpc.dart';

class ItSem4 extends StatelessWidget {
  const ItSem4({super.key});
  static const String routeName = "/itsem4";

  @override
  Widget build(BuildContext context) {
    It4QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
