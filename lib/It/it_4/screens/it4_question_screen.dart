...
import 'package:project_1/It/it_3/tools/it3_custom_appbar.dart';
...
class It4QuestionsScreen extends GetView<It4QuestionsController> {
  const It4QuestionsScreen({super.key});
  static const String routeName = "/it4questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<It4QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It4TestOverviewScreen.routeName)
