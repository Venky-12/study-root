...
import '../screens/it4_result_screen.dart';
import 'it4_qpc.dart';

class It4QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It4ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It4QPC>().navigateToQuestions(
