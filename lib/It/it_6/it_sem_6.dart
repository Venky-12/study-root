...
import 'controllers/it6_qpc.dart';

class ItSem6 extends StatelessWidget {
  const ItSem6({super.key});
  static const String routeName = "/itsem6";

  @override
  Widget build(BuildContext context) {
    It6QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
