...
import '../screens/it6_test_overview_screen.dart';

class It6CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const It6CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(It6TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
