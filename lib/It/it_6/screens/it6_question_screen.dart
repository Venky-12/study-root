...
class It6QuestionsScreen extends GetView<It6QuestionsController> {
  const It6QuestionsScreen({super.key});
  static const String routeName = "/it6questionsscreen";
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It6TestOverviewScreen.routeName)
