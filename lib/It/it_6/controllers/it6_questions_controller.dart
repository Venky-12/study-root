...
import '../screens/it6_result_screen.dart';
import 'it6_qpc.dart';

class It6QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It6ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It6QPC>().navigateToQuestions(
