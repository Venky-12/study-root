...
import '../screens/it2_result_screen.dart';
import 'it2_qpc.dart';

class It2QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It2ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It2QPC>().navigateToQuestions(
