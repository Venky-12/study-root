...
import '../../../eee/eee_1/tools/eee1_custom_appbar.dart';
import '../../../tools/main_button.dart';
import '../controllers/it2_questions_controller.dart';
import '../tools/it2_custom_appbar.dart';
import 'it2_test_overview_screen.dart';

class It2QuestionsScreen extends GetView<It2QuestionsController> {
  const It2QuestionsScreen({super.key});
  static const String routeName = "/it2questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<It2QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It2TestOverviewScreen.routeName)
