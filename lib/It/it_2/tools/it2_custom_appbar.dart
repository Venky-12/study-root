...
import '../screens/it2_test_overview_screen.dart';

class It2CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const It2CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(It2TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
