...
import 'package:project_1/It/it_2/tools/it2_question_card.dart';
...
import 'controllers/it2_qpc.dart';

class ItSem2 extends StatelessWidget {
  const ItSem2({super.key});
  static const String routeName = "/itsem2";

  @override
  Widget build(BuildContext context) {
    It2QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
