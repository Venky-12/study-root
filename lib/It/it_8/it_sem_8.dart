...
import 'package:project_1/It/it_8/tools/it8_question_card.dart';
...
import 'controllers/it8_qpc.dart';

class ItSem8 extends StatelessWidget {
  const ItSem8({super.key});
  static const String routeName = "/itsem8";

  @override
  Widget build(BuildContext context) {
    It8QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
