...
import 'package:project_1/It/it_8/controllers/it8_qpc.dart';
...
import '../screens/it8_result_screen.dart';

class It8QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It8ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It8QPC>().navigateToQuestions(
