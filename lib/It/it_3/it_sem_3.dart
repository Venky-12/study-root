...
import 'package:project_1/It/it_1/tools/it1_question_card.dart';
import 'package:project_1/It/it_3/tools/it3_question_card.dart';
...
import 'controllers/it3_qpc.dart';

class ItSem3 extends StatelessWidget {
  const ItSem3({super.key});
  static const String routeName = "/itsem3";

  @override
  Widget build(BuildContext context) {
    It3QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
