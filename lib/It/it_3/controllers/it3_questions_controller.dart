...
import '../screens/it3_result_screen.dart';
import 'it3_qpc.dart';

class It3QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It3ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It3QPC>().navigateToQuestions(
