...
import '../controllers/it3_questions_controller.dart';

class It3QuestionsScreen extends GetView<It3QuestionsController> {
  const It3QuestionsScreen({super.key});
  static const String routeName = "/it3questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<It3QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It3TestOverviewScreen.routeName)
