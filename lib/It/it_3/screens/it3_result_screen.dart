...
import '../tools/it3_custom_appbar.dart';

class It3ResultScreen extends GetView<It3QuestionsController> {
  const It3ResultScreen({super.key});
  static const String routeName = "/it3resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(It3AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
