...
import '../screens/it5_result_screen.dart';
import 'it5_qpc.dart';

class It5QuestionsController extends GetxController {
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> questionQuery = await itSemVqpRF
          .doc(questionPaper.id)
          .collection("itSem5Questions")
          .get();
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(It5ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<It5QPC>().navigateToQuestions(
