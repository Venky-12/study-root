...
import 'it5_answer_check_screen.dart';

class It5ResultScreen extends GetView<It5QuestionsController> {
  const It5ResultScreen({super.key});
  static const String routeName = "/it5resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(It5AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
