...
import 'package:project_1/It/it_4/screens/it4_test_overview_screen.dart';
import 'package:project_1/It/it_4/tools/it4_custom_appbar.dart';
import 'package:project_1/It/it_5/screens/it5_test_overview_screen.dart';
...
import '../controllers/it5_questions_controller.dart';
import '../tools/it5_custom_appbar.dart';

class It5QuestionsScreen extends GetView<It5QuestionsController> {
  const It5QuestionsScreen({super.key});
  static const String routeName = "/it5questionsscreen";

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: It5CustomAppBar(
        leading: Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<It5QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            It5TestOverviewScreen.routeName)
