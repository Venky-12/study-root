...
import 'package:project_1/It/it_5/tools/it5_question_card.dart';
...
import 'controllers/it5_qpc.dart';

class ItSem5 extends StatelessWidget {
  const ItSem5({super.key});
  static const String routeName = "/itsem5";

  @override
  Widget build(BuildContext context) {
    It5QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
