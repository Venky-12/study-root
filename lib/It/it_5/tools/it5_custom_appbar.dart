...
import '../screens/it5_test_overview_screen.dart';

class It5CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const It5CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(It5TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
