...
import '../screens/cse5_result_screen.dart';
import 'cse_5_qpc.dart';

class Cse5QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse5ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE5QPC>().navigateToQuestions(
