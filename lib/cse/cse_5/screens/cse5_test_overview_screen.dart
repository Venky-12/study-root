...
class Cse5TestOverviewScreen extends GetView<Cse5QuestionsController> {
  const Cse5TestOverviewScreen({super.key});

  static const String routeName = "/cse5testoverview";
