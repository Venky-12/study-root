...
import 'cse5_test_overview_screen.dart';

class Cse5QuestionsScreen extends GetView<Cse5QuestionsController> {
  const Cse5QuestionsScreen({super.key});
  static const String routeName = "/cse5questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Cse5QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse5TestOverviewScreen.routeName)
