...
import 'package:project_1/cse/cse_5/controllers/cse_5_questions_controller_extension.dart';
...
import '../controllers/cse5_questions_controller.dart';
import '../tools/cse5_custom_appbar.dart';
import 'cse5_answer_check_screen.dart';

class Cse5ResultScreen extends GetView<Cse5QuestionsController> {
  const Cse5ResultScreen({super.key});
  static const String routeName = "/cse5resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Cse5AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
