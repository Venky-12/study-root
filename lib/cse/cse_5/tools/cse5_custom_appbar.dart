...
import '../screens/cse5_test_overview_screen.dart';

class Cse5CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Cse5CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Cse5TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
