...
class SemistersCSEII extends StatefulWidget {
  const SemistersCSEII({super.key});

  @override
  State<SemistersCSEII> createState() => _SemistersCSEIIState();
}

class _SemistersCSEIIState extends State<SemistersCSEII> {
  @override
        ...
        child: Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/cse_sem3"),
                text: "Semister-III",
              ...
              MyButton(
                onTap: () => Get.offAndToNamed("/cse_sem4"),
                text: "Semister-IV",
                textColor: Colors.white,
                buttonColor: Colors.purple.shade700,
              ),
