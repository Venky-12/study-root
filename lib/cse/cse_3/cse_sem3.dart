...
import 'package:project_1/cse/cse_3/tools/cse3_question_card.dart';
...
import 'controllers/cse_3_qpc.dart';

class CseSem3 extends StatelessWidget {
  const CseSem3({super.key});
  static const String routeName = "/csesem3";

  @override
  Widget build(BuildContext context) {
    CSE3QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
