...
class Cse3TestOverviewScreen extends GetView<Cse3QuestionsController> {
  const Cse3TestOverviewScreen({super.key});

  static const String routeName = "/cse3testoverview";
