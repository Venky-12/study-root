...
import 'package:project_1/cse/cse_4/controllers/cse4_questions_controller_extension.dart';
import 'package:project_1/cse/cse_4/screens/cse4_answer_check_screen.dart';
...
import '../controllers/cse4_questions_controller.dart';
import '../tools/cse4_custom_appbar.dart';

class Cse4ResultScreen extends GetView<Cse4QuestionsController> {
  const Cse4ResultScreen({super.key});
  static const String routeName = "/cse4resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Cse4AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
