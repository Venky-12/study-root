...
import 'cse4_test_overview_screen.dart';

class Cse4QuestionsScreen extends GetView<Cse4QuestionsController> {
  const Cse4QuestionsScreen({super.key});
  static const String routeName = "/cse4questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Cse4QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse4TestOverviewScreen.routeName)
