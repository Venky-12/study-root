...
import '../screens/cse4_test_overview_screen.dart';

class Cse4CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Cse4CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Cse4TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
