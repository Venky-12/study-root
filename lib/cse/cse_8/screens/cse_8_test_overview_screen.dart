...
class Cse8TestOverviewScreen extends GetView<Cse8QuestionsController> {
  const Cse8TestOverviewScreen({super.key});

  static const String routeName = "/cse8testoverview";
