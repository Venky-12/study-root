...
import 'package:project_1/cse/cse_8/tools/cse_8_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class CseSem8 extends StatelessWidget {
  const CseSem8({super.key});
  static const String routeName = "/csesem8";

  @override
  Widget build(BuildContext context) {
    CSE8QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
