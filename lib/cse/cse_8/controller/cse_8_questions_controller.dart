...
class Cse8QuestionsController extends GetxController {
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> questionQuery =
          await cseSemVIIIqpRF
              .doc(questionPaper.id)
              .collection("cseSem8Questions")
              .get();
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse8ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE8QPC>().navigateToQuestions(
