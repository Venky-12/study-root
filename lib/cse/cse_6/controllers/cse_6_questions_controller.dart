...
import '../screens/cse_6_result_screen.dart';

class Cse6QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse6ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE6QPC>().navigateToQuestions(
