...
import 'package:project_1/cse/cse_6/controllers/cse_6_questions_controller_extension.dart';
...
import 'cse_6_answer_check_screen.dart';

class Cse6ResultScreen extends GetView<Cse6QuestionsController> {
  const Cse6ResultScreen({super.key});
  static const String routeName = "/cse6resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Cse6AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
