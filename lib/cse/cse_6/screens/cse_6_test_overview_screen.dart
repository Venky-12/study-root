...
class Cse6TestOverviewScreen extends GetView<Cse6QuestionsController> {
  const Cse6TestOverviewScreen({super.key});

  static const String routeName = "/cse6testoverview";
