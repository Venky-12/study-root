...
import 'cse_6_test_overview_screen.dart';

class Cse6QuestionsScreen extends GetView<Cse6QuestionsController> {
  const Cse6QuestionsScreen({super.key});
  static const String routeName = "/cse6questionsscreen";
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse6TestOverviewScreen.routeName)
