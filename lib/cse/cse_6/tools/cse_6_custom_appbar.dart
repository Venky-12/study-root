...
import '../screens/cse_6_test_overview_screen.dart';

class Cse6CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Cse6CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Cse6TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
