...
import '../controllers/cse_6_qpc.dart';

class CSE6QuestionCard extends StatelessWidget {
  CSE6QuestionCard({super.key, required this.model});

  final QuestionPaperModel model;
  final CSE6QPC _questionPaperController = CSE6QPC();
