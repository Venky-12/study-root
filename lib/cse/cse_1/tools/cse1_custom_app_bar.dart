...
import '../screens/cse1_testoverview_screen.dart';

class Cse1CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  const Cse1CustomAppBar(
      {super.key,
      this.title = "",
                  ...
                  if (showActionIcon)
                    Transform.translate(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Get.toNamed(Cse1TestOverviewScreen.routeName);
                          },
                        ))
                ],
              ),
