...
import 'package:project_1/cse/cse_1/tools/cse1_question_card.dart';

class CseSem1 extends StatelessWidget {
  const CseSem1({super.key});
  static const String routeName = "/csesem1";

  @override
  Widget build(BuildContext context) {
    CSE1QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
