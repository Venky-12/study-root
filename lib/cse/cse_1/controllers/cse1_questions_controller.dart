...
class Cse1QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse1ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE1QPC>().navigateToQuestions(
