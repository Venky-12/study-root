...
import 'package:project_1/cse/cse_1/tools/cse1_custom_app_bar.dart';
...
class Cse1QuestionsScreen extends GetView<Cse1QuestionsController> {
  const Cse1QuestionsScreen({super.key});
  static const String routeName = "/cse1questionsscreen";

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: Cse1CustomAppBar(
        leading: Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Cse1QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse1TestOverviewScreen.routeName)
