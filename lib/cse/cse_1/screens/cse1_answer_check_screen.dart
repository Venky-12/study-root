...
import '../controllers/cse1_questions_controller.dart';

class Cse1AnswerCheckScreen extends GetView<Cse1QuestionsController> {
  const Cse1AnswerCheckScreen({super.key});
  static String routeName = "/cse1answercheckscreen";
