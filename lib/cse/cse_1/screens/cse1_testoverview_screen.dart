...
class Cse1TestOverviewScreen extends GetView<Cse1QuestionsController> {
  const Cse1TestOverviewScreen({super.key});

  static const String routeName = "/cse1testoverview";
