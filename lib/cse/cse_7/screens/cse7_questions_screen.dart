...
class Cse7QuestionsScreen extends GetView<Cse7QuestionsController> {
  const Cse7QuestionsScreen({super.key});
  static const String routeName = "/cse7questionsscreen";
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse7TestOverviewScreen.routeName)
