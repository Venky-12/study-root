...
class Cse7TestOverviewScreen extends GetView<Cse7QuestionsController> {
  const Cse7TestOverviewScreen({super.key});

  static const String routeName = "/cse7testoverview";
