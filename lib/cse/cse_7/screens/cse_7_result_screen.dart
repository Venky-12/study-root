...
import 'package:project_1/cse/cse_7/controller/cse_7_question_controller_extension.dart';
...
class Cse7ResultScreen extends GetView<Cse7QuestionsController> {
  const Cse7ResultScreen({super.key});
  static const String routeName = "/cse7resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Cse7AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
