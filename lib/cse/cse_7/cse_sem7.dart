...
import 'package:project_1/cse/cse_7/tools/cse_7_question_card.dart';
import 'package:project_1/screens/options_screen.dart';
import 'package:project_1/tools/content_area.dart';

class CseSem7 extends StatelessWidget {
  const CseSem7({super.key});
  static const String routeName = "/csesem7";

  @override
  Widget build(BuildContext context) {
    CSE7QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
