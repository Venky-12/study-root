...
import '../screens/cse_7_result_screen.dart';
import 'cse_7_qpc.dart';

class Cse7QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse7ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE7QPC>().navigateToQuestions(
