...
import 'package:project_1/cse/cse_2/controllers/cse_2_qpc.dart';
...
import '../screens/cse2_result_screen.dart';

class Cse2QuestionsController extends GetxController {
  ...
  void complete() {
    _timer!.cancel();
    Get.offAndToNamed(Cse2ResultScreen.routeName);
  }

  void tryAgain() {
    Get.find<CSE2QPC>().navigateToQuestions(
