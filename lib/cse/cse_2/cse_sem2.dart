...
import 'package:project_1/cse/cse_2/tools/cse2_question_card.dart';
...
import 'controllers/cse_2_qpc.dart';

class CseSem2 extends StatelessWidget {
  const CseSem2({super.key});
  static const String routeName = "/csesem2";

  @override
  Widget build(BuildContext context) {
    CSE2QPC questionPaperController = Get.find();
    return Scaffold(
      body: Container(
