...
import 'package:project_1/cse/cse_2/screens/cse2_test_over_screen.dart';
...
class Cse2QuestionsScreen extends GetView<Cse2QuestionsController> {
  const Cse2QuestionsScreen({super.key});
  static const String routeName = "/cse2questionsscreen";
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              GetBuilder<Cse2QuestionsController>(
                                  id: 'answers_list',
                                  builder: ((context) {
                                ...
                                child: MainButton(
                                  onTap: (() {
                                    controller.isLastQuestion
                                        ? Get.toNamed(
                                            Cse2TestOverviewScreen.routeName)
