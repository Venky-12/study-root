...
class Cse2TestOverviewScreen extends GetView<Cse2QuestionsController> {
  const Cse2TestOverviewScreen({super.key});

  static const String routeName = "/cse2testoverview";
