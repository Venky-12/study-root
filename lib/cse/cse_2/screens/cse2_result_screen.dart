...
import 'package:project_1/cse/cse_2/controllers/cse2_questions_controller_extension.dart';
import 'package:project_1/cse/cse_2/screens/cse2_answer_check_screen.dart';
...
import '../controllers/cse2_questions_controller.dart';
import '../tools/cse2_custom_appbar.dart';

class Cse2ResultScreen extends GetView<Cse2QuestionsController> {
  const Cse2ResultScreen({super.key});
  static const String routeName = "/cse2resultscreen";
                              ...
                              return QuestionNumberCard(
                                  ...
                                  onTap: (() {
                                    controller.jumpToQuestion(index,
                                        isGoBack: false);
                                    Get.toNamed(
                                        Cse2AnswerCheckScreen.routeName);
                                  }));
                            })))
                  ],
                ),
